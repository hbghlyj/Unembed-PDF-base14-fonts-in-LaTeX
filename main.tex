...
\usepackage[italic]{mathastext}% This replaces CMR10 with Times (reducing 1.6KB in PDF output), and make "Math Italic" same as "Text Italic"

\begin{document}

\begin{center}
\scshape\Large Math test
\end{center}
